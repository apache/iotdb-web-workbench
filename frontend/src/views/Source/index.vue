    ...
    <div class="source-detail-container">
            ...
            <div class="permit-content">
                <div class="left-part">
                    <p class="title clearfix">
                        ...
                        <el-button type="text" @click="newUser()">{{
                            $t("sourcePage.newAccount")
                        }}</el-button>
                    </p>
                    <ul class="user-list">
                        <li
                ...
                <div class="right-part">
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane
                            :label="$t('sourcePage.baseConfig')"
                            name="1"
                        >
                            <div
                                v-if="!isNew"
                                class="tab-content left-base-content"
                            >
                                <el-form
                                    ref="baseInfoFormRef"
                                    :model="baseInfoForm"
                                ...
                                >
                                    <el-form-item
                                        :label="$t('sourcePage.userNameTitle')"
                                    >
                                        <div>{{ baseInfoForm.userName }}</div>
                                    </el-form-item>
                                    <el-form-item
                                        :label="$t('sourcePage.passwordTitle')"
                                        prop="password"
                                    ...
                                    >
                                        ...
                                        >
                                            <use
                                                xlink:href="#icon-se-icon-f-edit"
                                            ></use>
                                        </svg>
                                        <div v-if="!edit">
        ...
        <div class="storage-box">
            ...
            <el-table :data="tableData" style="width: 100%">
                <el-table-column
                    prop="groupName"
                    :label="$t('sourcePage.groupName')"
                    width="180"
                >
                </el-table-column>
                <el-table-column
                    prop="description"
                    :label="$t('sourcePage.description')"
                >
                </el-table-column>
                <el-table-column prop="ttl" :label="$t('sourcePage.line')">
                </el-table-column>

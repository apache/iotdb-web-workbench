...
public class MetricsServiceImpl implements MetricsService {
    ...
    public JVMMetricsListDataVO getCurrentThreadsCount(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.daemon.threads\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.live.threads\" " + "order by time desc limit 1";
        ...
        String latestResult = "前台:" + (totalThreadCount - demoThreadCount) + "个，后台:" + demoThreadCount + "个，线程总数:" + totalThreadCount + "个";
    ...
    public JVMMetricsListDataVO getCurrentDaemonThreadsCount(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.daemon.threads\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
    ...
    public JVMMetricsListDataVO getPeakThreadsCount(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.peak.threads\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String s1 = values.get(1);
    ...
    public JVMMetricsListDataVO getVariableThreadsCount(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=new\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=waiting\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=runnable\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=blocked\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=timed-waiting\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.threads.states.threads\".\"state=terminated\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String s1 = values.get(1);
        ...
        String latestScratchTime = simpleDateFormat.format(lastestTimeStamp);
        String latestResult = "新建(" + newThreadCount + ")、" + "可运行(" + waitingThreadCount + ")、" + "运行(" + runnableThreadCount + ")、" + "阻塞(" + blockedThreadCount + ")、" + "休眠(" + timedWaitingThreadCount + ")、" + "死亡(" + terminatedThreadCount + ")";
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        jvmMetricsListDataVO.setMetricType(metricType);
        jvmMetricsListDataVO.setDetailAvailable(detailAvailable);
        jvmMetricsListDataVO.setLatestResult(latestResult);
    ...
    public JVMMetricsListDataVO getYGCHappendCountAndCostTime(Connection connection) throws BaseException {
        ...
        String countSQL = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_count\".\"action=end of minor GC\".\"cause=Allocation Failure\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_count\".\"action=end of minor GC\".\"cause=Metadata GC Threshold\" " + "order by time desc limit 1";
        String timeSQL = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_total\".\"action=end of minor GC\".\"cause=Allocation Failure\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_total\".\"action=end of minor GC\".\"cause=Metadata GC Threshold\" " + "order by time desc limit 1";
        ...
        double time = (Double.parseDouble(timeValues.get(1))) / 1000;
    ...
    public JVMMetricsListDataVO getYGCMaxCostTimeAndReason(Connection connection) throws BaseException {
        ...
        String timeSQL = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_max\".\"action=end of minor GC\".\"cause=Metadata GC Threshold\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_max\".\"action=end of minor GC\".\"cause=Allocation Failure\" " + "order by time desc limit 1";
        List<String> timeValues = executeQueryOneLine(sessionPool, timeSQL);
    ...
    public JVMMetricsListDataVO getFGCHappendCountAndCostTime(Connection connection) throws BaseException {
        ...
        String countSQL = "select * from " +
                //            "root._metric.\"0.0.0.0:8086\".\"jvm.gc.pause_count\".\"action=end of
                // major GC\".\"cause=Allocation Failure\", " +
                "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_count\".\"action=end of major GC\".\"cause=Metadata GC Threshold\" " +
                //            "root._metric.\"0.0.0.0:8086\".\"jvm.gc.pause_count\".\"action=end of
                // major GC\".\"cause=Ergonomics\" " +
                "order by time desc limit 1";
        String timeSQL = "select * from " +
                //            "root._metric.\"0.0.0.0:8086\".\"jvm.gc.pause_total\".\"action=end of
                // major GC\".\"cause=Allocation Failure\", " +
                "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_total\".\"action=end of major GC\".\"cause=Metadata GC Threshold\" " +
                //            "root._metric.\"0.0.0.0:8086\".\"jvm.gc.pause_total\".\"action=end of
                // major GC\".\"cause=Ergonomics\" " +
                "order by time desc limit 1";
        List<String> countValues = executeQueryOneLine(sessionPool, countSQL);
        ...
        if (countValues.size() > 0) {
            long lastestTimeStamp = Long.parseLong(countValues.size() > 0 ? countValues.get(0) : "0");
            latestScratchTime = simpleDateFormat.format(lastestTimeStamp);
        ...
        if (timeValues.size() > 0) {
            ...
            d1 = timeValues.get(1).equals("null") ? 0.0 : Double.parseDouble(timeValues.get(1));
        }
        Integer detailAvailable = 2;
        double time = (d1) / 1000;
        String latestResult = count + "次 " + time + "s";
    ...
    public JVMMetricsListDataVO getFGCMaxCostTimeAndReason(Connection connection) throws BaseException {
        ...
        String timeSQL = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.pause_max\".\"action=end of major GC\".\"cause=Metadata GC Threshold\" " +
                "order by time desc limit 1";
        List<String> timeValues = executeQueryOneLine(sessionPool, timeSQL);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (timeValues.size() > 0) {
            ...
            jvmMetricsListDataVO.setLatestResult("0 s(Metadata GC Threshold)");
    ...
    public JVMMetricsListDataVO getGCCPUoverhead(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.overhead\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public JVMMetricsListDataVO getGCPromoted(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.memory.promoted.bytes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public JVMMetricsListDataVO getMajorMemoryMaxValueEver(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.max.data.size.bytes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public JVMMetricsListDataVO getMajorMemorySizeAfterGC(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.live.data.size.bytes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public JVMMetricsListDataVO getMinorMemorySizeAddedBetweentwoGC(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.gc.memory.allocated.bytes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public JVMMetricsListDataVO getBufferUsed(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.memory.used.bytes\".\"id=mapped\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.memory.used.bytes\".\"id=direct\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        ...
        if (values.size() > 0) {
            long lastestTimeStamp = Long.parseLong(values.get(0));
            String count = getNetFileSizeDescription((long) (Double.parseDouble(values.get(1)) + Double.parseDouble(values.get(2))));
            String latestScratchTime = simpleDateFormat.format(lastestTimeStamp);
            String latestResult = count;
            jvmMetricsListDataVO.setLatestResult(latestResult);
            jvmMetricsListDataVO.setLatestScratchTime(latestScratchTime);
    ...
    public JVMMetricsListDataVO getMaxBuffer(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.total.capacity.bytes\".\"id=mapped\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.total.capacity.bytes\".\"id=direct\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public JVMMetricsListDataVO getBufferCount(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.count.buffers\".\"id=mapped\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.buffer.count.buffers\".\"id=direct\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String s1 = values.get(1);
    ...
    public JVMMetricsListDataVO getJVMCommittedMemorySize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=nonheap\".\"id=Compressed Class Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=nonheap\".\"id=Code Cache\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=nonheap\".\"id=Metaspace\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=heap\".\"id=PS Old Gen\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=heap\".\"id=PS Eden Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.committed.bytes\".\"area=heap\".\"id=PS Survivor Space\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String count = getNetFileSizeDescription((long) (Double.parseDouble(values.get(1)) + Double.parseDouble(values.get(2)) + Double.parseDouble(values.get(3)) + Double.parseDouble(values.get(4)) + Double.parseDouble(values.get(5)) + Double.parseDouble(values.get(6))));
        String latestScratchTime = simpleDateFormat.format(lastestTimeStamp);
        String latestResult = count;
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public JVMMetricsListDataVO getJVMMemoryMaxSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=nonheap\".\"id=Compressed Class Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=nonheap\".\"id=Code Cache\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=nonheap\".\"id=Metaspace\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=heap\".\"id=PS Old Gen\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=heap\".\"id=PS Eden Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.max.bytes\".\"area=heap\".\"id=PS Survivor Space\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String count = getNetFileSizeDescription((long) (Double.parseDouble(values.get(1)) + Double.parseDouble(values.get(2)) + Double.parseDouble(values.get(3)) + Double.parseDouble(values.get(4)) + Double.parseDouble(values.get(5)) + Double.parseDouble(values.get(6))));
    ...
    public JVMMetricsListDataVO getJVMMemoryUsedSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=nonheap\".\"id=Compressed Class Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=nonheap\".\"id=Code Cache\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=nonheap\".\"id=Metaspace\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=heap\".\"id=PS Old Gen\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=heap\".\"id=PS Eden Space\", " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.memory.used.bytes\".\"area=heap\".\"id=PS Survivor Space\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        long lastestTimeStamp = Long.parseLong(values.get(0));
        String count = getNetFileSizeDescription((long) (Double.parseDouble(values.get(1)) + Double.parseDouble(values.get(2)) + Double.parseDouble(values.get(3)) + Double.parseDouble(values.get(4)) + Double.parseDouble(values.get(5)) + Double.parseDouble(values.get(6))));
    ...
    public JVMMetricsListDataVO getJVMUnloadedClassesTotal(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.classes.unloaded.classes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
    ...
    public JVMMetricsListDataVO getJVMloadedClassesTotal(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.classes.loaded.classes\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
    ...
    public JVMMetricsListDataVO getJVMCompilationTime(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"jvm.compilation.time.ms\".\"compiler=HotSpot 64-Bit Tiered Compilers\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        JVMMetricsListDataVO jvmMetricsListDataVO = new JVMMetricsListDataVO();
        if (values.size() > 0) {
    ...
    public MetricsListDataVO getCPUUsed(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"sys_cpu_load\".\"name=system\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public MetricsListDataVO getCPUCores(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"sys_cpu_cores\".\"name=system\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        MetricsListDataVO metricsListDataVO = new MetricsListDataVO();
        metricsListDataVO.setDetailAvailable(detailAvailable);
    ...
    public MetricsListDataVO getCPUTime(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"process_cpu_time\".\"name=process\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        MetricsListDataVO metricsListDataVO = new MetricsListDataVO();
        metricsListDataVO.setDetailAvailable(detailAvailable);
    ...
    public MetricsListDataVO getTotalMem(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"sys_total_physical_memory_size\".\"name=system\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        MetricsListDataVO metricsListDataVO = new MetricsListDataVO();
        metricsListDataVO.setDetailAvailable(detailAvailable);
    ...
    public MetricsListDataVO getProcessRatio(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"process_mem_ratio\".\"name=process\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
        MetricsListDataVO metricsListDataVO = new MetricsListDataVO();
        metricsListDataVO.setDetailAvailable(detailAvailable);
    ...
    public MetricsListDataVO getDiskTotalSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"sys_disk_total_space\".\"name=system\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public MetricsListDataVO getDiskAvailableSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"sys_disk_free_space\".\"name=system\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public MetricsListDataVO getWalFileCountAndSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"file_count\".\"name=wal\", " + "root._metric.\"0.0.0.0:" + port + "\".\"file_size\".\"name=wal\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public MetricsListDataVO getSeqTSFileCountAndSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"file_count\".\"name=seq\", " + "root._metric.\"0.0.0.0:" + port + "\".\"file_size\".\"name=seq\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    public MetricsListDataVO getUnSeqTSFileCountAndSize(Connection connection) throws BaseException {
        ...
        String sql = "select * from " + "root._metric.\"0.0.0.0:" + port + "\".\"file_count\".\"name=unseq\", " + "root._metric.\"0.0.0.0:" + port + "\".\"file_size\".\"name=unseq\" " + "order by time desc limit 1";
        SessionPool sessionPool = getSessionPool(connection);
        List<String> values = executeQueryOneLine(sessionPool, sql);
    ...
    @Override
    public List<MetricsListDataVO> getDiskMetricsDataList(Connection connection) throws BaseException {
        List<MetricsListDataVO> list = new ArrayList<>();
    ...
    @Override
    public List<MetricsListDataVO> getWriteMetricsDataList(Connection connection) throws BaseException {
        List<MetricsListDataVO> list = new ArrayList<>();
    ...
    @Override
    public QueryInfoVO getQueryInfo(Integer serverId, Integer queryClassificationId, Integer pageSize, Integer pageNum, String filterString, String startTimeStr, String endTimeStr, Integer executionResult) throws BaseException {
        long startTime = Long.parseLong(startTimeStr);
        long endTime = Long.parseLong(endTimeStr);
        Connection connection = connectionService.getById(serverId);
        QueryInfoDTO queryInfoDTO = iotDBService.getQueryInfoListByQueryClassificationId(connection, queryClassificationId, pageSize, pageNum, filterString, startTime, endTime, executionResult);
        ...
        queryInfoVO.setLatestRunningTime(latestRunningTime == 0 ? null : simpleDateFormat.format(latestRunningTime));
    ...
    @Override
    public MetricsDataForListVO getMetricsDataForList(Integer serverId, Integer metricsType) throws BaseException {
        Connection connection = connectionService.getById(serverId);

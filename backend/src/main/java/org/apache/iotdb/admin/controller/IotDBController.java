...
public class IotDBController {
  ...
  public BaseVO<MeasuremtnInfoVO> getMeasurementsByDeviceName(
    ...
    System.out.println("标记点1耗时：" + (currTime - prevTime));
    ...
    if (measurementDTOList != null) {
      ...
      for (MeasurementDTO measurementDTO : measurementDTOList) {
        ...
        String newValue = batchNewValue.get(index);
        Integer dataCount = Integer.parseInt(batchDataCount.get(index));
    ...
    System.out.println("标记点2计时：" + (currTime - prevTime));

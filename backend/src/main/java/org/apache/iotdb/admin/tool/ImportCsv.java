...
public class ImportCsv {
    ...
    public ImportDataVO importCsv(
            String host, Integer port, String username, String password, String filename, String timeZone) throws BaseException {
    ...
    private ImportDataVO loadDataFromCSV(File file, Session session) throws BaseException {
        ...
        try (BufferedReader br =
            ...
            if (cols.length <= 1) {
                throw new BaseException(ErrorCode.FILE_FIRST_LINE_ILLEGAL, ErrorCode.FILE_FIRST_LINE_ILLEGAL_MSG);
            }
    ...
    private long parseTime(String str, boolean useFormatter, SimpleDateFormat timeFormatter) throws BaseException {
        try {
            if (useFormatter) {
    ...
    private void splitColToDeviceAndMeasurement(
            ...
            int position) throws BaseException {
        if (col.length() > 0) {
    ...
    private int[] nextNode(String path, List<String> nodes, char enclose, int startIndex, int i) throws BaseException {
